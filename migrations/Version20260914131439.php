 ...
 */
final class Version20260914131439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorite ADD user_id INT DEFAULT NULL, ADD tracks_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE favorite ADD CONSTRAINT FK_68C58ED9A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE favorite ADD CONSTRAINT FK_68C58ED98FA7F33 FOREIGN KEY (tracks_id) REFERENCES track (id)');
        $this->addSql('CREATE INDEX IDX_68C58ED9A76ED395 ON favorite (user_id)');
        $this->addSql('CREATE INDEX IDX_68C58ED98FA7F33 ON favorite (tracks_id)');
        $this->addSql('ALTER TABLE listen_history ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE listen_history ADD CONSTRAINT FK_76651E5DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_76651E5DA76ED395 ON listen_history (user_id)');
        ...
        $this->addSql('ALTER TABLE track ADD album_id INT DEFAULT NULL, ADD listen_history_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE track ADD CONSTRAINT FK_D6E3F8A61137ABCF FOREIGN KEY (album_id) REFERENCES album (id)');
        $this->addSql('ALTER TABLE track ADD CONSTRAINT FK_D6E3F8A6EBBCD2AD FOREIGN KEY (listen_history_id) REFERENCES listen_history (id)');
        $this->addSql('CREATE INDEX IDX_D6E3F8A61137ABCF ON track (album_id)');
        $this->addSql('CREATE INDEX IDX_D6E3F8A6EBBCD2AD ON track (listen_history_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorite DROP FOREIGN KEY FK_68C58ED98FA7F33');
        $this->addSql('DROP INDEX IDX_68C58ED9A76ED395 ON favorite');
        $this->addSql('DROP INDEX IDX_68C58ED98FA7F33 ON favorite');
        $this->addSql('ALTER TABLE favorite DROP user_id, DROP tracks_id');
        $this->addSql('ALTER TABLE listen_history DROP FOREIGN KEY FK_76651E5DA76ED395');
        $this->addSql('DROP INDEX IDX_76651E5DA76ED395 ON listen_history');
        $this->addSql('ALTER TABLE listen_history DROP user_id');
        ...
        $this->addSql('ALTER TABLE track DROP FOREIGN KEY FK_D6E3F8A6EBBCD2AD');
        $this->addSql('DROP INDEX IDX_D6E3F8A61137ABCF ON track');
        $this->addSql('DROP INDEX IDX_D6E3F8A6EBBCD2AD ON track');
        $this->addSql('ALTER TABLE track DROP album_id, DROP listen_history_id');
    }
}
